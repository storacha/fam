    ...
    <div className='h-screen flex'>
      <div className='flex-none w-14 border-r border-dashed border-hot-red bg-clip-padding bg-storacha-sideways'>
        <div className='h-screen flex flex-col justify-between text-center pt-3 pb-1'>
          <div>
            <NavLink to="/bucket" style={{ lineHeight: 0 }} className={() => `${location.pathname === '/bucket' ? 'bg-hot-red text-white m-1 p-1 rounded-full' : 'text-hot-red hover:text-black p-2'} inline-block`} title='Buckets'>
